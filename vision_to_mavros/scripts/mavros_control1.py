...
class MavController:
    ...
    def callback(self):
        ...
        """
        self.goto_xyz_rpy(self.x,self.y,self.z,self.th,self.speed,self.turn)
...
def simple_demo():
    ...
    c.takeoff(0.75)
    rospy.sleep(5)
    c.goto_xyz_rpy(0,0,3.0,0,0,0)
    rospy.sleep(5)
    
    print("Waypoint 1: position control")
    c.goto_xyz_rpy(0.0,0.0,3,0,0,-1*pi_2)
    rospy.sleep(5)
    c.goto_xyz_rpy(0.4,0.0,3,0,0,-1*pi_2)
    rospy.sleep(5)
    print("Waypoint 2: position control")
    c.goto_xyz_rpy(0.4,0.0,3,0,0,0)
    rospy.sleep(5)
    c.goto_xyz_rpy(0.4,0.4,3,0,0,0)
    rospy.sleep(5)
    print("Waypoint 3: position control")
    c.goto_xyz_rpy(0.4,0.4,3,0,0,pi_2)
    rospy.sleep(5)
    c.goto_xyz_rpy(0.0,0.4,3,0,0,pi_2)
    rospy.sleep(5)
    print("Waypoint 4: position control")
    c.goto_xyz_rpy(0.0,0.4,3,0,0,2*pi_2)
    rospy.sleep(5)
    c.goto_xyz_rpy(0.0,0.0,3,0,0,2*pi_2)
    rospy.sleep(5)
